...
public class Other extends avd_message_base_bean {
	...
	public void initial(byte [] bytes)
	{
		...
		Backward_speed_=DESUtil.bytesToInt(bytes, 16, 6);
		...
		Forward_enable_=DESUtil.bytesToInt(bytes, 8, 13);
		B_ackward__enable__=DESUtil.bytesToInt(bytes, 8, 13);
		Brake_drive_stop_enable__=DESUtil.bytesToInt(bytes, 8, 13);
		Motor_protection_enable__=DESUtil.bytesToInt(bytes, 8, 13);
