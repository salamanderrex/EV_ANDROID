...
public class SYS_RealTimeInfo extends avd_message_base_bean {
	...
	public short MotorT;
	public short Mos_T;
	public short lac_ref;
	public short lac_actual;
	...
	public void initial(byte[] bytes) {
		...
		lac_ref = DESUtil.bytesToSignInt16(bytes[13], bytes[14]);
		Throttle_vdc = DESUtil.bytesToUnSignInt16(bytes[15], bytes[16]);

		lac_actual = DESUtil.bytesToSignInt16(bytes[21], bytes[22]);
